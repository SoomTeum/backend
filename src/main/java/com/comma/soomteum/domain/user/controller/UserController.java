...
public class UserController {
    ...
    @GetMapping("/")
    public ApiResponse<UserProfileResponseDto> getUserProfile(@Parameter(hidden = true) @LoginUser User user) {
        return ApiResponse.ok(userService.getUserProfile(user.getUserId()));
    }
